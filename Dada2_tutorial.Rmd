...
# Installation du package BiocManager et de phyloseq
```{r}
...
ps
```
Nous rangeons les séquences dans une taxonomie. 


```{r}
plot_richness(ps, x="Day", measures=c("Shannon", "Simpson"), color="When")
```
Nous voyons que l'alpha-diversité est sensiblement la même, selon qu'on utilise Simpson ou Shannon.
