...
#Learn the Error Rates - Visualization
```{r}
...
#Construct Sequence Table - Amplicon Sequence Variant Table
```{r}
...
```
Chimeras account about 4% merged sequence reads when we account for the abundance of variants.
...
head(taxa.print)
```
Bacteroidota are well represented
